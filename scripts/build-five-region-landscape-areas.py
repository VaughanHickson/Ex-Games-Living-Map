...
OUTFILE = OUTDIR / "five-region-landscape-areas-001.json"
...
def main():
            ...
            for result in participant.get("resolution", []):
                ...
                if key not in areas:
                    ...
                    areas[key] = {
                        ...
                        "participantNames": [],
                        "evidence": {
                            "origin": "nine-region-locality-resolution-001",
    ...
    print("EX GAMES LIVING MAP — FIVE-REGION LANDSCAPE AREA BUILD")
    print("=" * 76)
