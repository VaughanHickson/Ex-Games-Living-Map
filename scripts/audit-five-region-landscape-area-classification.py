...
SRC = ROOT / "data" / "geography" / "staged" / "five-region-landscape-areas-001.json"
OUT = ROOT / "data" / "geography" / "staged" / "five-region-landscape-area-classification-audit-001.json"
...
def main():
    ...
    print("EX GAMES LIVING MAP — FIVE-REGION LANDSCAPE AREA CLASSIFICATION AUDIT")
    print("=" * 76)
