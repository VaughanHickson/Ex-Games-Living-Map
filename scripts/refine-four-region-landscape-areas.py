...
AREAS = ROOT / "data" / "geography" / "staged" / "four-region-landscape-areas-001.json"
AUDIT = ROOT / "data" / "geography" / "staged" / "four-region-landscape-area-classification-audit-001.json"
OUT = ROOT / "data" / "geography" / "staged" / "four-region-landscape-areas-002.json"
...
def main():
    ...
    print("EX GAMES LIVING MAP — REFINED FOUR-REGION LANDSCAPE AREAS")
    print("=" * 76)
