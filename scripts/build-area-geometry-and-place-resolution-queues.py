...
SRC = ROOT / "data" / "geography" / "staged" / "four-region-landscape-areas-002.json"
OUTDIR = ROOT / "data" / "geography" / "staged"
GEOM = OUTDIR / "four-region-area-geometry-queue-001.json"
PLACE = OUTDIR / "four-region-place-resolution-queue-001.json"
...
def main():
    ...
    print("EX GAMES LIVING MAP — AREA GEOMETRY + PLACE RESOLUTION QUEUES")
    print("=" * 76)
